...
## Directions
1.  Rename this file `<MegManning>_A01_Introduction.Rmd` (replacing `<FirstLast>` with your first and last name).
...
> Answer: In college I took a data science course where we breifly used R and Git to create visuals for scientific data. That course happened a few years ago and it was completely remote due to COVID, so I feel like a brand new user to R and Git with no formal training.

2. Are there any components of the course about which you feel confident?

> Answer: Honestly, I am feely a bit overwhelmed, but excited to learn more. I am excited to think about data visualizations/applications of R, but not confident on how to use it yet.

3. Are there any components of the course about which you feel apprehensive?

> Answer: I've never had any formal training in coding, so I'm a little nervous about learning everything and keeping up with the class. 
...
> Answer: https://github.com/megmanning1/EDE_Fall2023
