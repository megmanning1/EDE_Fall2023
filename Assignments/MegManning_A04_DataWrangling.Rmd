...
EPAair_03_2018_parsed <- select(EPAair_03_2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
EPAair_03_2019_parsed <- select(EPAair_03_2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
EPAair_PM25_2018_parsed <- select(EPAair_PM25_2018, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
EPAair_PM25_2019_parsed <- select(EPAair_PM25_2019, Date, DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)
...
EPAair_data <- rbind(EPAair_03_2018_parsed, EPAair_03_2019_parsed, EPAair_PM25_2018_parsed, EPAair_PM25_2019_parsed)
...
EPAair_spread <- pivot_wider(EPAair_processed, names_from = AQS_PARAMETER_DESC, values_from = meanAQI)
