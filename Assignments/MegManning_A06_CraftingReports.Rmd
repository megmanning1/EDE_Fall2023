...
```{r Boxplots, echo=FALSE, warning=FALSE, fig.height=3, fig.width=5, fig.cap="Distribution of Ozone", fig.align='left'}
...
ozone_2018 <- ggplot(filter(epa_data, Year == 2018), 
  ...
  labs(y = "Ozone (µg/m3)",
       x = "Month",
       title = "Distribution of Ozone in 2018")
print(ozone_2018)
...
ozone_2019 <- ggplot(filter(epa_data, Year == 2019), 
  ...
  labs(y = "Ozone (µg/m3)",
       x = "Month",
       title = "Distribution of Ozone in 2019")
print(ozone_2019)
```
