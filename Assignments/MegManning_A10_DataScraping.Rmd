...
#9 "Map" the "scrape.it" function to retrieve data for 2010 thru 2021
#SOMETHING IS WRONG WITH MAP2 :(
PWSID <- "01-11-010"
the_years <- 2010:2021

df_2010_2021 <- map2(the_years, PWSID, scrape.it) %>%
  bind_rows()

#Plot
ggplot(df_2010_2021,aes(y = Max_Day_Use, x=PWSID)) +
  geom_boxplot()
