...
#4 Total phosphorus (tp_ug) by phosphate (po4) --> RUNNING INTO ISSUES WITH NAS?
ggplot(filter(NTL_LTER_processed, 
              lakename == "Peter Lake" | lakename == "Paul Lake"),
       aes(x = "po4", 
           y = "tp_ug")) +
  geom_point() +
...
ggplot(NTL_LTER_processed, 
       aes(x = month, y = temperature, color = lakename)) +
  geom_boxplot()
