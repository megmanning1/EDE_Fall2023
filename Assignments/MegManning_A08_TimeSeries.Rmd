...
ozonebytime.monthly <- ggplot(GaringerOzone.monthly, aes(x = Date,
                                                         y = MonthlyOzone)) +
  geom_point() +
  geom_line() +
  geom_smooth(method = "lm",
...
GaringerOzone.monthly.ts2 <- ts(GaringerOzone_Components$trend,
                   start=c(f_year,f_month),
                   frequency=12)

#GaringerOzone_Components <- mutate(GaringerOzone.monthly,
...
GaringerOzone.monthly.trend2 <- Kendall::SeasonalMannKendall(GaringerOzone.monthly.ts2)
